...
func (ai *ArgInfo) Type() *TypeInfo {
	...
	return (*TypeInfo)(unsafe.Pointer(ptr))
}
...
func (ci *CallableInfo) Arg(n int) *ArgInfo {
	...
	return (*ArgInfo)(unsafe.Pointer(ptr))
}
...
func (fi *FunctionInfo) Property() *PropertyInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*PropertyInfo)(unsafe.Pointer(ptr))
}
...
func (fi *FunctionInfo) VFunc() *VFuncInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*VFuncInfo)(unsafe.Pointer(ptr))
}
...
//                                                         GError **error);
//func (fi *FunctionInfo) Invoke(inArgs []Argument, outArgs []Argument, returnValue *Argument) error {
//	var err *C.GError
//	var cInArgs *C.GIArgument
//	if len(inArgs) > 0 {
//		cInArgs = (*C.GIArgument)(unsafe.Pointer(&inArgs[0]))
//	}
//	var cOutArgs *C.GIArgument
//	if len(outArgs) > 0 {
//		cOutArgs = (*C.GIArgument)(unsafe.Pointer(&outArgs[0]))
//	}
//
//	ret := C.g_function_info_invoke(fi.c, cInArgs, C.int(len(inArgs)), cOutArgs, C.int(len(outArgs)),
//		(*C.GIArgument)(unsafe.Pointer(returnValue)), &err)
//	if ret == 0 {
//		// error
...
func (vfi *VFuncInfo) Signal() *SignalInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*SignalInfo)(unsafe.Pointer(ptr))
}
...
func (vfi *VFuncInfo) Invoker() *FunctionInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*FunctionInfo)(unsafe.Pointer(ptr))
}
...
func (ei *EnumInfo) Value(n int) *ValueInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*ValueInfo)(unsafe.Pointer(ptr))
}
...
func (ii *InterfaceInfo) Prerequisite(n int) *BaseInfo {
	...
	return (*BaseInfo)(unsafe.Pointer(ptr))
}
...
func (ii *InterfaceInfo) Constant(n int) *ConstantInfo {
	...
	return (*ConstantInfo)(unsafe.Pointer(ptr))
}
...
func (ii *InterfaceInfo) InterfaceStruct() *StructInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*StructInfo)(unsafe.Pointer(ptr))
}
...
func (oi *ObjectInfo) Parent() *ObjectInfo {
	...
	ptr := &BaseInfo{cptr}
	return (*ObjectInfo)(unsafe.Pointer(ptr))
}
...
func (oi *ObjectInfo) Interface(n int) *InterfaceInfo {
	...
	return (*InterfaceInfo)(unsafe.Pointer(ptr))
}
...
func (oi *ObjectInfo) Field(n int) *FieldInfo {
	...
	return (*FieldInfo)(unsafe.Pointer(ptr))
}
